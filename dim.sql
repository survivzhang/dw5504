...
CREATE TABLE DimVehicleType (
    ...
    BusInvolvement BOOLEAN NOT NULL,           -- 公交车涉事
    HeavyRigidTruckInvolvement BOOLEAN NOT NULL, -- 重型刚性卡车涉事
    ArticulatedTruckInvolvement BOOLEAN NOT NULL -- 关节卡车涉事
);
...
CREATE TABLE DimAccidentInfo (
    ...
    CrashID VARCHAR(50) NOT NULL,              -- 事故ID
...
CREATE TABLE DimSpecialPeriod (
    ...
    ChristmasPeriod BOOLEAN NOT NULL,            -- 是否是圣诞节期间
    EasterPeriod BOOLEAN NOT NULL                -- 是否是复活节期间
);
